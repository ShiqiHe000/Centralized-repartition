...
!        PRINT *, "H2_LOAD_BALANCING", LOAD_BALANCING
    ...
    CALL MPI_SCATTERV(GSPLIT_TRACKING, SENDCOUNTS, DISPLS2, MPI_DOUBLE_PRECISION, &
                       SPLIT_TRACKING, NEL_LOCAL, MPI_DOUBLE_PRECISION, &
                        0, MPI_COMM_WORLD, IERROR)
    !-------------------------------------------------------------------
